...
#[no_mangle]
pub extern "C" fn vector_rust_hnsw_should_init_lock_tranche_kernel(
...
#[no_mangle]
pub extern "C" fn vector_rust_hnsw_should_end_parallel_build_kernel(
    has_leader: bool,
) -> bool {
    has_leader
}
...
#[no_mangle]
pub extern "C" fn vector_rust_hnsw_should_scan_heap_for_build_kernel(
    has_heap: bool,
) -> bool {
    has_heap
}
...
#[no_mangle]
pub extern "C" fn vector_rust_hnsw_should_handle_empty_work_list_kernel(
    work_list_length: i32,
) -> bool {
    work_list_length == 0
}

#[no_mangle]
pub extern "C" fn vector_rust_hnsw_should_advance_on_exhausted_heaptids_kernel(
    heaptids_length: i32,
) -> bool {
    heaptids_length == 0
}
...
#[no_mangle]
pub extern "C" fn vector_rust_hnsw_should_reject_missing_orderby_kernel(
...
#[no_mangle]
pub extern "C" fn vector_rust_hnsw_should_initialize_scan_state_kernel(
    is_first_scan: bool,
) -> bool {
    is_first_scan
}
...
#[no_mangle]
pub extern "C" fn vector_rust_hnsw_should_increment_instrument_searches_kernel(
    has_instrument: bool,
) -> bool {
    has_instrument
}
...
#[no_mangle]
pub extern "C" fn vector_rust_hnsw_should_skip_parallel_workers_kernel(
    parallel_workers: i32,
) -> bool {
    parallel_workers == 0
}
...
#[no_mangle]
pub extern "C" fn vector_rust_hnsw_should_fallback_without_workers_kernel(
...
#[no_mangle]
pub extern "C" fn vector_rust_hnsw_should_leader_participate_kernel(
...
#[no_mangle]
pub extern "C" fn vector_rust_hnsw_should_use_debug_query_string_kernel(
    has_debug_query_string: bool,
) -> bool {
    has_debug_query_string
}
...
#[no_mangle]
pub extern "C" fn vector_rust_hnsw_should_log_leader_progress_kernel(
    progress_is_leader: bool,
) -> bool {
    progress_is_leader
}
...
#[no_mangle]
pub extern "C" fn vector_rust_hnsw_should_skip_null_build_tuple_kernel(
    is_null: bool,
) -> bool {
    is_null
}
...
pub extern "C" fn vector_rust_hnsw_should_finish_parallel_heap_scan_kernel(
    ...
    participants_done == participant_count
}
